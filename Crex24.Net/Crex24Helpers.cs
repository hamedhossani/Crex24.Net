...
namespace Crex24.Net
{
    ...
    /// Crex24 helpers
    /// </summary>
    public static class Crex24Helpers
    {
        /// <summary>
        ...
        public static void ValidateCrex24Symbol(this string symbolString)
        {
            if (string.IsNullOrEmpty(symbolString))
                throw new ArgumentException("Symbol is not provided");

            if (!Regex.IsMatch(symbolString, "^([A-Z]{5,})$"))
                throw new ArgumentException($"{symbolString} is not a valid CoinEx symbol. Should be [QuoteCurrency]-[BaseCurrency], e.g. ETH-BTC");
        }
    }
}
